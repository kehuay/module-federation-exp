...
// tinymce 移动端预览
// import { mobilePreview } from './plugins/preview'
...
export default {
    ...
    plugins: `preview importcss searchreplace autolink autosave save directionality visualblocks visualchars fullscreen image link media table charmap pagebreak nonbreaking anchor insertdatetime advlist lists wordcount help charmap quickbars emoticons accordion
        ${import.meta.env.MODE === 'dev' ? ' code codesample' : ''}`,
    // https://www.tiny.cloud/docs/tinymce/6/menus-configuration-options/#example-the-tinymce-default-menu-items
    menu: {
        view: {
            title: 'View',
            items: 'preview2 preview | fullscreen | visualaid visualchars visualblocks',
        },
        insert: {
            title: 'Insert',
            items:
                'localimage localvideo localaudio docx | image link media addcomment pageembed template codesample inserttable | charmap emoticons hr | pagebreak nonbreaking anchor tableofcontents | insertdatetime',
        },
    },
    async setup(editor) {
        ...
        //   icon: 'image',
        //   onAction: () => {
        //     InsertFile.open({ type: '图片', editor })
        //   },
        // })
        ...
        //   icon: 'embed',
        //   onAction: () => {
        //     InsertFile.open({ type: '视频', editor })
        //   },
        // })
        ...
        //   icon: 'arrow-right',
        //   onAction: () => {
        //     InsertFile.open({ type: '音频', editor })
        //   },
        // })
    ...
    images_upload_handler(blobInfo, progress) {
        ...
        // return POST.upload(
        //   `${import.meta.env.VITE_BASE_URL_INFRA}file/upload`,
        //   {
        //     file,
        //     configId: import.meta.env.VITE_BASE_FILE_UPLOAD_CONFIGID,
        //   },
        //   {
        //     headers: {
